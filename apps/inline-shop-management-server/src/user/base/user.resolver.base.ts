...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [Buyer], { name: "buyers" })
  async findBuyers(
    @graphql.Parent() parent: User,
    @graphql.Args() args: BuyerFindManyArgs
  ): Promise<Buyer[]> {
    const results = await this.service.findBuyers(parent.id, args);
  ...
  @graphql.ResolveField(() => [Seller], { name: "sellers" })
  async findSellers(
    @graphql.Parent() parent: User,
