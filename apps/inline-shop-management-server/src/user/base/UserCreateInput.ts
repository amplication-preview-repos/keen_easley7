...
class UserCreateInput {
  @ApiProperty({
    required: false,
    type: () => BuyerCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => BuyerCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => BuyerCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => SellerCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => SellerCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => SellerCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
